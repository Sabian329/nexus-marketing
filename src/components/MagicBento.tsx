...
import "../style/MagicBento.css";

const DEFAULT_PARTICLE_COUNT = 12;
const DEFAULT_SPOTLIGHT_RADIUS = 300;
const DEFAULT_GLOW_COLOR = "237, 115, 30";
...
const cardData = [
	{
		...
		description: "Nowoczesne, responsywne strony React",
	...
	},
	{
		color: "#0a0a0a",
		title: "E-commerce",
		description: "Sklepy online z Shopify API",
		label: "E-commerce",
		image: null,
		isLarge: false,
	},
	{
		color: "#0a0a0a",
		title: "Google Ads",
		description: "Kampanie reklamowe w wyszukiwarce",
		label: "PPC",
		image:
